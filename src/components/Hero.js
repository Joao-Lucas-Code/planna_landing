...
export default function Hero() {
  return (
    <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center px-[5%] pt-28 relative overflow-hidden">
      {/* 1. Badge - Aparece primeiro (delay curto ou padrão) */}
      ...
      {/* 2. Título - Aparece com um pequeno delay (delay-200) */}
      ...
      {/* 3. Subtítulo - Aparece depois (delay-400) */}
      <p className="reveal delay-400 mt-6 text-gray-400 text-lg md:text-xl max-w-[560px] leading-relaxed">
      ...
      {/* 4. Botões - Aparecem por último na sequência de texto (delay-600) */}
      <div className="reveal delay-600 mt-10 mb-16 flex gap-4 items-center">
      ...
      {/* 5. Mockup - Aparece como o "gran finale" (delay-800 ou delay-1000) */}
